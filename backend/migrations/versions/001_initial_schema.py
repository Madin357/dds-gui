...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("demand_level", sa.String(20)),
        sa.Column("growth_rate", sa.Numeric(6, 2)),
        sa.Column("relevance_to", ARRAY(sa.String)),
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("uuid_generate_v4()")),
        sa.Column("student_id", UUID(as_uuid=True), sa.ForeignKey("students.id", ondelete="CASCADE"), nullable=False, unique=True),
        sa.Column("institution_id", UUID(as_uuid=True), sa.ForeignKey("institutions.id", ondelete="CASCADE"), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("uuid_generate_v4()")),
        sa.Column("program_id", UUID(as_uuid=True), sa.ForeignKey("programs.id", ondelete="CASCADE"), nullable=False, unique=True),
        sa.Column("institution_id", UUID(as_uuid=True), sa.ForeignKey("institutions.id", ondelete="CASCADE"), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column("connection_config", JSON, nullable=False),
        sa.Column("tables_to_sync", ARRAY(sa.String), nullable=False),
    ...
    op.create_table(
        "sync_job_runs",
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("uuid_generate_v4()")),
        sa.Column("sync_job_id", UUID(as_uuid=True), sa.ForeignKey("sync_jobs.id", ondelete="CASCADE"), nullable=False, index=True),
        sa.Column("status", sa.String(30), nullable=False),
    ...
    op.create_table(
        "sync_checkpoints",
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("uuid_generate_v4()")),
        sa.Column("sync_job_id", UUID(as_uuid=True), sa.ForeignKey("sync_jobs.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("transform_config", JSON),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()")),
    )
    ...
    op.create_table(
        "integration_errors",
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("uuid_generate_v4()")),
        sa.Column("sync_job_run_id", UUID(as_uuid=True), sa.ForeignKey("sync_job_runs.id", ondelete="SET NULL")),
        sa.Column("institution_id", UUID(as_uuid=True), sa.ForeignKey("institutions.id", ondelete="CASCADE"), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column("institution_id", UUID(as_uuid=True), sa.ForeignKey("institutions.id"), index=True),
