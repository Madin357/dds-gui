        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-3">
              <img src="/logo.svg" alt="EduScope" className="w-12 h-12" />
            </div>
          ...
          <div className="mt-6 text-center">
            <a href="/" className="text-sm text-[#0ea5e9] hover:underline">{t("common.backToHome")}</a>
          </div>
          <div className="mt-4 border-t border-slate-100 pt-4">
            <p className="text-xs text-slate-400 text-center">{t("login.demoCreds")}</p>
            <p className="text-xs text-slate-400 text-center">admin@beu.edu.az / demo123</p>
            <p className="text-xs text-slate-400 text-center">admin@digitalacademy.az / demo123</p>
          </div>
        </div>
      </div>
    </div>
